...
export const SECTIONS: Section[] = [
  ...
  { id: "files", label: "Fichiers", icon: FolderTree, perServer: true, description: "Explorateur SFTP, recherche et grep distants, archives, comparaison, transferts entre serveurs, édition distante." },
  ...
  { id: "docker", label: "Docker", icon: Container, perServer: true, description: "Conteneurs, logs en direct, exec, stats, compose, catalogue d'applications 1-clic, registres privés et nettoyage de disque." },
  { id: "databases", label: "Bases de données", icon: Database, perServer: true, description: "Bases MySQL/MariaDB, PostgreSQL et SQLite : tables, requêtes SQL, édition en place, export CSV, et explorateur Redis." },
